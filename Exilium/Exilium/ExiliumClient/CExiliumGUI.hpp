...
class CExiliumGUI final : public IExiliumGUI
{
public:
...
private:
	...
	enum EExiliumGuiStyle_t : uint32_t
	{
		EXILIUM_GUI_STYLE_INDIGO,
		EXILIUM_GUI_STYLE_VERMILLION,
		EXILIUM_GUI_STYLE_CLASSIC_STEAM,
	};
