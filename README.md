...
- There's a move_crc bypass (all actions are done in ExiliumClient.cpp -> OnCreateMove.GetCL_Bypass()->SetViewAngles).
...
- Normal working rendering of all the [removed] and fonts (Example in ExiliumClient.cpp, CVIsual.cpp)
- Possibly something else, but I can't remember. Good luck to everyone.

# Links:
[UnknownCheats Thread](https://www.unknowncheats.me/forum/counter-strike-2-a/722929-exilium-cs2-internal-base.html)<br>
