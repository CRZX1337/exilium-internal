...
{
	int32 m_numRoundsSurvivedStreak; // 0x00B8
	int32 m_maxNumRoundsSurvivedStreak; // 0x00BC
	int32 m_numRoundsSurvivedTotal; // 0x00C0
	int32 m_iRoundsWonWithoutPurchase; // 0x00C4
	int32 m_iRoundsWonWithoutPurchaseTotal; // 0x00C8
	int32 m_numFirstKills; // 0x00CC
	int32 m_numClutchKills; // 0x00D0
	int32 m_numPistolKills; // 0x00D4
	int32 m_numSniperKills; // 0x00D8
	int32 m_iNumSuicides; // 0x00DC
	int32 m_iNumTeamKills; // 0x00E0
	float32 m_flTeamDamage; // 0x00E4
};
...
{
	Vector[64] m_firePositions; // 0x0738
	Vector[64] m_fireParentPositions; // 0x0A38
	bool[64] m_bFireIsBurning; // 0x0D38
	Vector[64] m_BurnNormal; // 0x0D78
	int32 m_fireCount; // 0x1078
	int32 m_nInfernoType; // 0x107C
	int32 m_nFireEffectTickBegin; // 0x1080
	float32 m_nFireLifetime; // 0x1084
	bool m_bInPostEffectTime; // 0x1088
	bool m_bWasCreatedInSmoke; // 0x1089
	Extent m_extent; // 0x1290
	CountdownTimer m_damageTimer; // 0x12A8
	CountdownTimer m_damageRampTimer; // 0x12C0
	Vector m_splashVelocity; // 0x12D8
	Vector m_InitialSplashVelocity; // 0x12E4
	Vector m_startPos; // 0x12F0
	Vector m_vecOriginalSpawnLocation; // 0x12FC
	IntervalTimer m_activeTimer; // 0x1308
	int32 m_fireSpawnOffset; // 0x1318
	int32 m_nMaxFlames; // 0x131C
	int32 m_nSpreadCount; // 0x1320
	CountdownTimer m_BookkeepingTimer; // 0x1328
	CountdownTimer m_NextSpreadTimer; // 0x1340
	uint16 m_nSourceItemDefIndex; // 0x1358
};
...
class CGameRules // server
{
	...
	int32 m_nTotalPausedTicks; // 0x00B4
	int32 m_nPauseStartTick; // 0x00B8
	bool m_bGamePaused; // 0x00BC
};
...
class CCSBot : public CBot // server
{
	...
	float32 m_stateTimestamp; // 0x0578
	bool m_isAttacking; // 0x057C
	bool m_isOpeningDoor; // 0x057D
	CHandle< CBaseEntity > m_taskEntity; // 0x0584
	VectorWS m_goalPosition; // 0x0594
	CHandle< CBaseEntity > m_goalEntity; // 0x05A0
	CHandle< CBaseEntity > m_avoid; // 0x05A4
	float32 m_avoidTimestamp; // 0x05A8
	bool m_isStopping; // 0x05AC
	bool m_hasVisitedEnemySpawn; // 0x05AD
	IntervalTimer m_stillTimer; // 0x05B0
	bool m_bEyeAnglesUnderPathFinderControl; // 0x05C0
	int32 m_pathIndex; // 0x5EC0
	...
	float32 m_pathLadderEnd; // 0x5F44
	...
	uint8 m_travelDistancePhase; // 0x60D8
	uint8 m_hostageEscortCount; // 0x6270
	float32 m_hostageEscortCountTimestamp; // 0x6274
	int32 m_desiredTeam; // 0x6278
	...
	float32 m_noiseTravelDistance; // 0x62BC
	float32 m_noiseTimestamp; // 0x62C0
	...
	float32 m_lookAroundStateTimestamp; // 0x6308
	float32 m_lookAheadAngle; // 0x630C
	float32 m_forwardAngle; // 0x6310
	float32 m_inhibitLookAroundTimestamp; // 0x6314
	Vector m_lookAtSpot; // 0x631C
	float32 m_lookAtSpotDuration; // 0x632C
	float32 m_lookAtSpotTimestamp; // 0x6330
	float32 m_lookAtSpotAngleTolerance; // 0x6334
	bool m_lookAtSpotClearIfClose; // 0x6338
	bool m_lookAtSpotAttack; // 0x6339
	char* m_lookAtDesc; // 0x6340
	float32 m_peripheralTimestamp; // 0x6348
	uint8 m_approachPointCount; // 0x64D0
	...
	float32 m_spotCheckTimestamp; // 0x6538
	int32 m_checkedHidingSpotCount; // 0x6940
	float32 m_lookPitch; // 0x6944
	float32 m_lookPitchVel; // 0x6948
	float32 m_lookYaw; // 0x694C
	float32 m_lookYawVel; // 0x6950
	...
	float32 m_aimFocus; // 0x6994
	float32 m_aimFocusInterval; // 0x6998
	GameTime_t m_aimFocusNextUpdate; // 0x699C
	CountdownTimer m_ignoreEnemiesTimer; // 0x69A8
	CHandle< CCSPlayerPawn > m_enemy; // 0x69C0
	bool m_isEnemyVisible; // 0x69C4
	uint8 m_visibleEnemyParts; // 0x69C5
	Vector m_lastEnemyPosition; // 0x69C8
	float32 m_lastSawEnemyTimestamp; // 0x69D4
	float32 m_firstSawEnemyTimestamp; // 0x69D8
	float32 m_currentEnemyAcquireTimestamp; // 0x69DC
	float32 m_enemyDeathTimestamp; // 0x69E0
	float32 m_friendDeathTimestamp; // 0x69E4
	bool m_isLastEnemyDead; // 0x69E8
	int32 m_nearbyEnemyCount; // 0x69EC
	CHandle< CCSPlayerPawn > m_bomber; // 0x6BF8
	int32 m_nearbyFriendCount; // 0x6BFC
	CHandle< CCSPlayerPawn > m_closestVisibleFriend; // 0x6C00
	CHandle< CCSPlayerPawn > m_closestVisibleHumanFriend; // 0x6C04
	IntervalTimer m_attentionInterval; // 0x6C08
	CHandle< CCSPlayerPawn > m_attacker; // 0x6C18
	float32 m_attackedTimestamp; // 0x6C1C
	IntervalTimer m_burnedByFlamesTimer; // 0x6C20
	int32 m_lastVictimID; // 0x6C30
	...
	uint8 m_enemyQueueIndex; // 0x6D40
	uint8 m_enemyQueueCount; // 0x6D41
	uint8 m_enemyQueueAttendIndex; // 0x6D42
	...
	int32 m_avgVelIndex; // 0x6DB4
	int32 m_avgVelCount; // 0x6DB8
	Vector m_lastOrigin; // 0x6DBC
	float32 m_lastRadioRecievedTimestamp; // 0x6DCC
	float32 m_lastRadioSentTimestamp; // 0x6DD0
	CHandle< CCSPlayerPawn > m_radioSubject; // 0x6DD4
	Vector m_radioPosition; // 0x6DD8
	float32 m_voiceEndTimestamp; // 0x6DE4
	int32 m_lastValidReactionQueueFrame; // 0x6DF0
};
...
{
	bool m_bSinglePlayerGameEnding; // 0x00C0
};
...
class CCSPlayer_MovementServices : public CPlayer_MovementServices_Humanoid // server
{
	...
	GameTick_t m_nLastJumpTick; // 0x0590
	float32 m_flLastJumpFrac; // 0x0594
	float32 m_flLastJumpVelocityZ; // 0x0598
	bool m_bJumpApexPending; // 0x059C
	float32 m_flTicksSinceLastSurfingDetected; // 0x05A0
	bool m_bWasSurfing; // 0x05A4
	Vector m_vecInputRotated; // 0x0634
};
...
{
	bool m_bFreezePeriod; // 0x00C8
	bool m_bWarmupPeriod; // 0x00C9
	GameTime_t m_fWarmupPeriodEnd; // 0x00CC
	GameTime_t m_fWarmupPeriodStart; // 0x00D0
	bool m_bTerroristTimeOutActive; // 0x00D4
	bool m_bCTTimeOutActive; // 0x00D5
	float32 m_flTerroristTimeOutRemaining; // 0x00D8
	float32 m_flCTTimeOutRemaining; // 0x00DC
	int32 m_nTerroristTimeOuts; // 0x00E0
	int32 m_nCTTimeOuts; // 0x00E4
	bool m_bTechnicalTimeOut; // 0x00E8
	bool m_bMatchWaitingForResume; // 0x00E9
	int32 m_iFreezeTime; // 0x00EC
	int32 m_iRoundTime; // 0x00F0
	float32 m_fMatchStartTime; // 0x00F4
	GameTime_t m_fRoundStartTime; // 0x00F8
	GameTime_t m_flRestartRoundTime; // 0x00FC
	bool m_bGameRestart; // 0x0100
	float32 m_flGameStartTime; // 0x0104
	float32 m_timeUntilNextPhaseStarts; // 0x0108
	int32 m_gamePhase; // 0x010C
	int32 m_totalRoundsPlayed; // 0x0110
	int32 m_nRoundsPlayedThisPhase; // 0x0114
	int32 m_nOvertimePlaying; // 0x0118
	int32 m_iHostagesRemaining; // 0x011C
	bool m_bAnyHostageReached; // 0x0120
	bool m_bMapHasBombTarget; // 0x0121
	bool m_bMapHasRescueZone; // 0x0122
	bool m_bMapHasBuyZone; // 0x0123
	bool m_bIsQueuedMatchmaking; // 0x0124
	int32 m_nQueuedMatchmakingMode; // 0x0128
	bool m_bIsValveDS; // 0x012C
	bool m_bLogoMap; // 0x012D
	bool m_bPlayAllStepSoundsOnServer; // 0x012E
	int32 m_iSpectatorSlotCount; // 0x0130
	int32 m_MatchDevice; // 0x0134
	bool m_bHasMatchStarted; // 0x0138
	int32 m_nNextMapInMapgroup; // 0x013C
	char[512] m_szTournamentEventName; // 0x0140
	char[512] m_szTournamentEventStage; // 0x0340
	char[512] m_szMatchStatTxt; // 0x0540
	char[512] m_szTournamentPredictionsTxt; // 0x0740
	int32 m_nTournamentPredictionsPct; // 0x0940
	GameTime_t m_flCMMItemDropRevealStartTime; // 0x0944
	GameTime_t m_flCMMItemDropRevealEndTime; // 0x0948
	bool m_bIsDroppingItems; // 0x094C
	bool m_bIsQuestEligible; // 0x094D
	bool m_bIsHltvActive; // 0x094E
	bool m_bBombPlanted; // 0x094F
	uint16[100] m_arrProhibitedItemIndices; // 0x0950
	uint32[4] m_arrTournamentActiveCasterAccounts; // 0x0A18
	int32 m_numBestOfMaps; // 0x0A28
	int32 m_nHalloweenMaskListSeed; // 0x0A2C
	bool m_bBombDropped; // 0x0A30
	int32 m_iRoundWinStatus; // 0x0A34
	int32 m_eRoundWinReason; // 0x0A38
	bool m_bTCantBuy; // 0x0A3C
	bool m_bCTCantBuy; // 0x0A3D
	int32[30] m_iMatchStats_RoundResults; // 0x0A40
	int32[30] m_iMatchStats_PlayersAlive_CT; // 0x0AB8
	int32[30] m_iMatchStats_PlayersAlive_T; // 0x0B30
	float32[32] m_TeamRespawnWaveTimes; // 0x0BA8
	GameTime_t[32] m_flNextRespawnWave; // 0x0C28
	Vector m_vMinimapMins; // 0x0CA8
	Vector m_vMinimapMaxs; // 0x0CB4
	float32[8] m_MinimapVerticalSectionHeights; // 0x0CC0
	uint64 m_ullLocalMatchID; // 0x0CE0
	int32[10] m_nEndMatchMapGroupVoteTypes; // 0x0CE8
	int32[10] m_nEndMatchMapGroupVoteOptions; // 0x0D10
	int32 m_nEndMatchMapVoteWinner; // 0x0D38
	int32 m_iNumConsecutiveCTLoses; // 0x0D3C
	int32 m_iNumConsecutiveTerroristLoses; // 0x0D40
	bool m_bHasHostageBeenTouched; // 0x0D60
	GameTime_t m_flIntermissionStartTime; // 0x0D64
	GameTime_t m_flIntermissionEndTime; // 0x0D68
	bool m_bLevelInitialized; // 0x0D6C
	int32 m_iTotalRoundsPlayed; // 0x0D70
	int32 m_iUnBalancedRounds; // 0x0D74
	bool m_endMatchOnRoundReset; // 0x0D78
	bool m_endMatchOnThink; // 0x0D79
	int32 m_iNumTerrorist; // 0x0D7C
	int32 m_iNumCT; // 0x0D80
	int32 m_iNumSpawnableTerrorist; // 0x0D84
	int32 m_iNumSpawnableCT; // 0x0D88
	CUtlVector< int32 > m_arrSelectedHostageSpawnIndices; // 0x0D90
	int32 m_nSpawnPointsRandomSeed; // 0x0DA8
	bool m_bFirstConnected; // 0x0DAC
	bool m_bCompleteReset; // 0x0DAD
	bool m_bPickNewTeamsOnReset; // 0x0DAE
	bool m_bScrambleTeamsOnRestart; // 0x0DAF
	bool m_bSwapTeamsOnRestart; // 0x0DB0
	CUtlVector< int32 > m_nEndMatchTiedVotes; // 0x0DB8
	bool m_bNeedToAskPlayersForContinueVote; // 0x0DD4
	uint32 m_numQueuedMatchmakingAccounts; // 0x0DD8
	float32 m_fAvgPlayerRank; // 0x0DDC
	char* m_pQueuedMatchmakingReservationString; // 0x0DE0
	uint32 m_numTotalTournamentDrops; // 0x0DE8
	uint32 m_numSpectatorsCountMax; // 0x0DEC
	uint32 m_numSpectatorsCountMaxTV; // 0x0DF0
	uint32 m_numSpectatorsCountMaxLnk; // 0x0DF4
	int32 m_nCTsAliveAtFreezetimeEnd; // 0x0E00
	int32 m_nTerroristsAliveAtFreezetimeEnd; // 0x0E04
	bool m_bForceTeamChangeSilent; // 0x0E08
	bool m_bLoadingRoundBackupData; // 0x0E09
	int32 m_nMatchInfoShowType; // 0x0E40
	float32 m_flMatchInfoDecidedTime; // 0x0E44
	int32 mTeamDMLastWinningTeamNumber; // 0x0E60
	float32 mTeamDMLastThinkTime; // 0x0E64
	float32 m_flTeamDMLastAnnouncementTime; // 0x0E68
	int32 m_iAccountTerrorist; // 0x0E6C
	int32 m_iAccountCT; // 0x0E70
	int32 m_iSpawnPointCount_Terrorist; // 0x0E74
	int32 m_iSpawnPointCount_CT; // 0x0E78
	int32 m_iMaxNumTerrorists; // 0x0E7C
	int32 m_iMaxNumCTs; // 0x0E80
	int32 m_iLoserBonusMostRecentTeam; // 0x0E84
	float32 m_tmNextPeriodicThink; // 0x0E88
	bool m_bVoiceWonMatchBragFired; // 0x0E8C
	float32 m_fWarmupNextChatNoticeTime; // 0x0E90
	int32 m_iHostagesRescued; // 0x0E98
	int32 m_iHostagesTouched; // 0x0E9C
	float32 m_flNextHostageAnnouncement; // 0x0EA0
	bool m_bNoTerroristsKilled; // 0x0EA4
	bool m_bNoCTsKilled; // 0x0EA5
	bool m_bNoEnemiesKilled; // 0x0EA6
	bool m_bCanDonateWeapons; // 0x0EA7
	float32 m_firstKillTime; // 0x0EAC
	float32 m_firstBloodTime; // 0x0EB4
	bool m_hostageWasInjured; // 0x0ED0
	bool m_hostageWasKilled; // 0x0ED1
	bool m_bVoteCalled; // 0x0EE0
	bool m_bServerVoteOnReset; // 0x0EE1
	float32 m_flVoteCheckThrottle; // 0x0EE4
	bool m_bBuyTimeEnded; // 0x0EE8
	int32 m_nLastFreezeEndBeep; // 0x0EEC
	bool m_bTargetBombed; // 0x0EF0
	bool m_bBombDefused; // 0x0EF1
	bool m_bMapHasBombZone; // 0x0EF2
	Vector m_vecMainCTSpawnPos; // 0x0F40
	CUtlVector< SpawnPoint* > m_CTSpawnPointsMasterList; // 0x0F50
	CUtlVector< SpawnPoint* > m_TerroristSpawnPointsMasterList; // 0x0F68
	bool m_bRespawningAllRespawnablePlayers; // 0x0F80
	int32 m_iNextCTSpawnPoint; // 0x0F84
	float32 m_flCTSpawnPointUsedTime; // 0x0F88
	int32 m_iNextTerroristSpawnPoint; // 0x0F8C
	float32 m_flTerroristSpawnPointUsedTime; // 0x0F90
	CUtlVector< SpawnPoint* > m_CTSpawnPoints; // 0x0F98
	CUtlVector< SpawnPoint* > m_TerroristSpawnPoints; // 0x0FB0
	bool m_bIsUnreservedGameServer; // 0x0FC8
	float32 m_fAutobalanceDisplayTime; // 0x0FCC
	bool m_bAllowWeaponSwitch; // 0x1008
	bool m_bRoundTimeWarningTriggered; // 0x1009
	GameTime_t m_phaseChangeAnnouncementTime; // 0x100C
	float32 m_fNextUpdateTeamClanNamesTime; // 0x1010
	GameTime_t m_flLastThinkTime; // 0x1014
	float32 m_fAccumulatedRoundOffDamage; // 0x1018
	int32 m_nShorthandedBonusLastEvalRound; // 0x101C
	int32 m_nMatchAbortedEarlyReason; // 0x1068
	bool m_bHasTriggeredRoundStartMusic; // 0x106C
	bool m_bSwitchingTeamsAtRoundReset; // 0x106D
	CCSGameModeRules* m_pGameModeRules; // 0x1088
	KeyValues3 m_BtGlobalBlackboard; // 0x1090
	CHandle< CBaseEntity > m_hPlayerResource; // 0x1128
	CRetakeGameRules m_RetakeRules; // 0x1130
	CUtlVector< int32 >[4] m_arrTeamUniqueKillWeaponsMatch; // 0x1320
	bool[4] m_bTeamLastKillUsedUniqueWeaponMatch; // 0x1380
	uint8 m_nMatchEndCount; // 0x13A8
	int32 m_nTTeamIntroVariant; // 0x13AC
	int32 m_nCTTeamIntroVariant; // 0x13B0
	bool m_bTeamIntroPeriod; // 0x13B4
	GameTime_t m_fTeamIntroPeriodEnd; // 0x13B8
	bool m_bPlayedTeamIntroVO; // 0x13BC
	int32 m_iRoundEndWinnerTeam; // 0x13C0
	int32 m_eRoundEndReason; // 0x13C4
	bool m_bRoundEndShowTimerDefend; // 0x13C8
	int32 m_iRoundEndTimerTime; // 0x13CC
	CUtlString m_sRoundEndFunFactToken; // 0x13D0
	CPlayerSlot m_iRoundEndFunFactPlayerSlot; // 0x13D8
	int32 m_iRoundEndFunFactData1; // 0x13DC
	int32 m_iRoundEndFunFactData2; // 0x13E0
	int32 m_iRoundEndFunFactData3; // 0x13E4
	CUtlString m_sRoundEndMessage; // 0x13E8
	int32 m_iRoundEndPlayerCount; // 0x13F0
	bool m_bRoundEndNoMusic; // 0x13F4
	int32 m_iRoundEndLegacy; // 0x13F8
	uint8 m_nRoundEndCount; // 0x13FC
	int32 m_iRoundStartRoundNumber; // 0x1400
	uint8 m_nRoundStartCount; // 0x1404
	float64 m_flLastPerfSampleTime; // 0x5410
};
class CPulseCell_Outflow_CycleShuffled : public CPulseCell_BaseFlow // pulse_runtime_lib
{
	CUtlVector< CPulse_OutflowConnection > m_Outputs; // 0x0048
...
class CMolotovProjectile : public CBaseCSGrenadeProjectile // server
{
	...
	bool m_bHasBouncedOffPlayer; // 0x0CB0
};
...
class CCSPlayer_MovementServices : public CPlayer_MovementServices_Humanoid // client
{
	...
	GameTick_t m_nLastJumpTick; // 0x0580
	float32 m_flLastJumpFrac; // 0x0584
	float32 m_flLastJumpVelocityZ; // 0x0588
	bool m_bJumpApexPending; // 0x058C
	float32 m_flTicksSinceLastSurfingDetected; // 0x0590
	bool m_bWasSurfing; // 0x0594
	Vector m_vecInputRotated; // 0x0624
};
